#' Cox Analysis
#'
#' @param variables Variable for analysis
...
#' @param p_cut P value cutoff for univariate analysis
#' @param censored OS time cutoff; 60 is recommended
#' @param included_uni Results of univariate analysis were included or not
#'
#' @return
